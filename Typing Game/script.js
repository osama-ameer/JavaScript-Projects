...
const settinngsDifficulty = document.getElementById('difficulty');
...
settinngsDifficulty.value = localStorage.getItem('difficulty') !== null ? localStorage.getItem('difficulty') : 'easy';
...
//1. function to generate a word at random from wordlist
...
//2. when clicking the setting button
